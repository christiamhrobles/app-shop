...
Route::middleware(['auth','admin'])->prefix('admin')->namespace('Admin')->group(function () {
	...
	Route::post('/products','ProductController@store');  //crear productos//registrar
	...
	Route::get('/categories/create','CategoryController@create');  //crear Categoryos//formulario
	Route::post('/categories','CategoryController@store');  //crear Categoryos//registrar
